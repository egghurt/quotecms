    ...
    public Object call(Object[] objects, Context context) {
        ...
        if(items!=null&&items.size()>0) {
            ...
            for(TCmsItem i:items) {
                ...
                sbf.append("<tr><td><label for=\"item-" + i.getItemId() + "\" class=\"control-label x85\">" + i.getItemName() + "</label>");
                sbf.append("<input type=\"hidden\" id=\"item-" + i.getItemId() + "\" name=\"itemId\" value=\""+i.getItemId()+"\"></td>");
