...
public class DocumentUtil {
    ...
    public static  IndexObject document2IndexObject(Analyzer analyzer, Highlighter highlighter, Document doc,float score) throws Exception {
        ...
        indexObject.setDescripton(stringFormatHighlighterOut(analyzer, highlighter,doc,"description")==null?doc.get("description"):stringFormatHighlighterOut(analyzer, highlighter,doc,"description"));
