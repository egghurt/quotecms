...
public class CacheController {
    ...
    private String[] caches={"cms-site-cache","cms-category-cache","cms-item-cache","shiro-kickout-cache","cms-content-cache","cms-data-cache",
            "cms-model-cache","cms-pattern-cache","cms-topic-cache"};
